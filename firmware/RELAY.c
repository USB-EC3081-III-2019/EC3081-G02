...
void Luz_03_Artificial_Manual(){
    ...
    LCD_Escribir_Cadena("Las luces han sido ");
     LCD_Cursor(-10,2);
    LCD_Escribir_Cadena("encendidas");
}
void Luz_05_Artificial_Manual(){
    LCD_Cmd(0x01); // Limpiar Display
    LCD_Cursor(1,1);
...
void RELAY_01(){
    LCD_Cmd(0x01); // Limpiar Display
    LCD_Cursor(1,1);
    LCD_Escribir_Cadena("1.Activar");
    LCD_Cursor(-8,2);
    LCD_Escribir_Cadena("2.Desactivar");
}
